! function (e) {
    ...
    new k("起點", 2000, "goodEvent", "sean", 18), new k("中國", 5000, 0, "", 19), new k("越南", 1000, 0, "", 20), new k("韓國", 1300, 0, "", 21), new k("機會", 1000, "surprise", "sean", 22), new k("日本", 3000, 0, "", 23), new k("俄羅斯", 4000, 0, "", 24), new k("白雲機場", 1000, "airport", "sean", 25), new k("交所得稅", 1000, "badEvent", "sean", 26), new k("命運", 1000, "surprise", "sean", 27), new k("埃及", 1600, 0, "", 28), new k("監獄", 0, "jail", "sean", 29), new k("澳大利亞", 2400, 0, "", 17), new k("紐西蘭", 1800, 0, "", 15), new k("南極洲", 2e4, 0, "", 13), new k("賭場", 1000, "casino", "sean", 11), new k("機會", 1000, "surprise", "sean", 10), new k("撿到錢", 1000, "goodEvent", "sean", 9), new k("巴西", 2000, 0, "", 8), new k("阿根廷", 2200, 0, "", 7), new k("墨西哥", 2400, 0, "", 6), new k("美國", 4500, 0, "", 5), new k("義大利", 3000, 0, "", 4), new k("倫敦機場", 1000, "airport", "sean", 3), new k("英國", 3600, 0, "", 2), new k("命運", 1000, "surprise", "sean", 1), new k("阿爾卑斯山", 1000, "trip", "sean", 0), new k("德國", 3400, 0, "", 12), new k("法國", 3200, 0, "", 14), new k("西班牙", 2800, 0, "", 16);
    var H = [];

    function S(e, n, t) {
        this.text = e, this.value = n, this.stop = t, H.push(this)
    }
    new S("扶老奶奶過馬路的事蹟被大家知道了，校長會頒發$1000獎金", 1000, 0),
        new S("中了樂透，獲得頭獎$5000", 5000, 0),
        new S("在街邊被劫匪搶劫，為了保住性命，失去$3000", -3000, 0),
        new S("喝了一杯飲料，花費$30", -30, 0),
        new S("路邊撿到$500", 500, 0),
        new S("吃魚卡到魚刺，去醫院花了$800", -800, 0),
        new S("錢包忘在計程車上，丟失$1000", -1000, 0),
        new S("空閒時間去兼職，收穫$2000", 2000, 0),
        new S("扶老奶奶過馬路摔了一跤，買藥花了$100", -100, 0),
        new S("手機突然壞了，換了iPhone16，花費$1300", -1300, 0),
        new S("吃火鍋，花費$500", -500, 0),
        new S("去日本看櫻花，花費$2000", -2000, 0),
        new S("什麼也沒有發生，除了錢包少了$800", -800, 0),
        new S("什麼也沒有發生, 除了錢包多了$1000", 1000, 0),
        new S("在學校擔任志工，獲得$0", 0, 0),
        new S("在校門口發傳單，得到$100", 100, 0),
        new S("獲得模範生獎學金，獎金$3000", 3000, 0),
        new S("搶到錢母，獲得$1", 1, 0),
        new S("夢見得到$3000獎金，醒來決定花$50去拜神", -50, 0),
        new S("獲得了$3000獎金！趕緊花$500去還願", 2500, 0),
        new S("突然很渴想買瓶礦泉水，花費$5", -5, 0),
        new S("買房子沒繳稅罰款$1000，拘留1日", -1000, 1),
        new S("超速行駛被罰款$2000，拘留2天", -2000, 2),
        new S("被查水錶發現有違建，罰款$1000並拘留3日", -1000, 3),
        new S("考試作弊被拘留5日", 0, 5),
        new S("【任務】現場唱營歌，獲得100元", 100, 0),
        new S("【任務】學一隻動物的叫聲，並模仿10秒，獲得100元", 100, 0),
        new S("【任務】找一位朋友手牽手繞場地走一圈，獲得100元", 100, 0),
        new S("【任務】唱一句你最喜歡的歌曲，並請大家猜歌名，獲得100元", 100, 0),
        new S("【任務】在場地中找三個紅色的物品，並大聲說出來，獲得100元", 100, 0),
        new S("【任務】對一位夥伴說「你今天超帥！」或「你今天超美！」，獲得100元", 100, 0),
        new S("【任務】跟小草老師說「你好帥」，獲得100元", 100, 0),
        new S("【任務】學一隻企鵝走路，繞講台一圈，獲得100元", 100, 0),
        new S("【任務】說一個冷笑話，獲得100元", 100, 0),
        new S("【任務】假裝你是忍者，擺出三個不同的帥氣動作，獲得100元", 100, 0),
        new S("【任務】模仿一位老師的經典台詞或動作，獲得100元", 100, 0),
        new S("【任務】跳一段你覺得最酷的舞蹈給大家看，獲得100元", 100, 0),
        new S("【任務】用最快的速度轉五圈後，停下來學貓叫三聲，獲得100元", 100, 0),
        new S("【任務】跟一位隊輔哥哥或姐姐說「謝謝你，辛苦了」，獲得100元", 100, 0),
        new S("【任務】模仿你最喜歡的卡通角色，並說一句經典台詞，獲得100元", 100, 0),
        new S("【任務】用單腳跳三圈，並大喊「我是科學王！」，獲得100元", 100, 0);
    var j, C = 0,
        q = 0,
        A = 0,
        O = 0,
